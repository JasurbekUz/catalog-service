...
func (m *PostBook) Reset()         { *m = PostBook{} }
func (m *PostBook) String() string { return proto.CompactTextString(m) }
func (*PostBook) ProtoMessage()    {}
func (*PostBook) Descriptor() ([]byte, []int) {
	return fileDescriptor_0abbfcf058acdf89, []int{2}
}
func (m *PostBook) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PostBook) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PostBook.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PostBook) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PostBook.Merge(m, src)
}
func (m *PostBook) XXX_Size() int {
	return m.Size()
}
func (m *PostBook) XXX_DiscardUnknown() {
	xxx_messageInfo_PostBook.DiscardUnknown(m)
}

var xxx_messageInfo_PostBook proto.InternalMessageInfo

func (m *PostBook) GetBookId() string {
	if m != nil {
		return m.BookId
	}
	return ""
...
func (m *PostBook) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *PostBook) GetAuthorId() string {
	if m != nil {
		return m.AuthorId
	}
	return ""
...
type BookCategory struct {
	RelationId           string   `protobuf:"bytes,1,opt,name=relationId,proto3" json:"relationId"`
...
func (m *BookCategory) GetRelationId() string {
	if m != nil {
		return m.RelationId
	}
	return ""
...
type Book struct {
	...
	Author               *Author     `protobuf:"bytes,2,opt,name=author,proto3" json:"author"`
	Categories           []*Category `protobuf:"bytes,3,rep,name=categories,proto3" json:"categories"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func init() {
	...
	proto.RegisterType((*PostBook)(nil), "catalog.PostBook")
...
var fileDescriptor_0abbfcf058acdf89 = []byte{
	...
	,
}
...
type CatalogServiceClient interface {
	...
	CreateBook(ctx context.Context, in *PostBook, opts ...grpc.CallOption) (*Book, error)
	...
	UpdateBook(ctx context.Context, in *PostBook, opts ...grpc.CallOption) (*Book, error)
	DeleteBook(ctx context.Context, in *ByIdReq, opts ...grpc.CallOption) (*Empty, error)
	CreateBookCategory(ctx context.Context, in *BookCategory, opts ...grpc.CallOption) (*Book, error)
	UpdateBookCategory(ctx context.Context, in *BookCategory, opts ...grpc.CallOption) (*Book, error)
}
...
func (c *catalogServiceClient) CreateBook(ctx context.Context, in *PostBook, opts ...grpc.CallOption) (*Book, error) {
	out := new(Book)
...
func (c *catalogServiceClient) UpdateBook(ctx context.Context, in *PostBook, opts ...grpc.CallOption) (*Book, error) {
	out := new(Book)
...
func (c *catalogServiceClient) CreateBookCategory(ctx context.Context, in *BookCategory, opts ...grpc.CallOption) (*Book, error) {
	out := new(Book)
...
func (c *catalogServiceClient) UpdateBookCategory(ctx context.Context, in *BookCategory, opts ...grpc.CallOption) (*Book, error) {
	out := new(Book)
...
type CatalogServiceServer interface {
	...
	CreateBook(context.Context, *PostBook) (*Book, error)
	GetBook(context.Context, *ByIdReq) (*Book, error)
	GetBooks(context.Context, *ListReq) (*BookListResp, error)
	UpdateBook(context.Context, *PostBook) (*Book, error)
	DeleteBook(context.Context, *ByIdReq) (*Empty, error)
	CreateBookCategory(context.Context, *BookCategory) (*Book, error)
	UpdateBookCategory(context.Context, *BookCategory) (*Book, error)
}
...
func (*UnimplementedCatalogServiceServer) CreateBook(ctx context.Context, req *PostBook) (*Book, error) {
...
func (*UnimplementedCatalogServiceServer) UpdateBook(ctx context.Context, req *PostBook) (*Book, error) {
...
func (*UnimplementedCatalogServiceServer) CreateBookCategory(ctx context.Context, req *BookCategory) (*Book, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateBookCategory not implemented")
}
func (*UnimplementedCatalogServiceServer) UpdateBookCategory(ctx context.Context, req *BookCategory) (*Book, error) {
...
func _CatalogService_CreateBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatalogServiceServer).CreateBook(ctx, req.(*PostBook))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CatalogService_UpdateBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatalogServiceServer).UpdateBook(ctx, req.(*PostBook))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *Category) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CategoryParentId) > 0 {
		...
		i = encodeVarintCatalog(dAtA, i, uint64(len(m.CategoryParentId)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Name) > 0 {
...
func (m *PostBook) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PostBook) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PostBook) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BookCategory) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RelationId) > 0 {
		...
		i = encodeVarintCatalog(dAtA, i, uint64(len(m.RelationId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *PostBook) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PostBook: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PostBook: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
